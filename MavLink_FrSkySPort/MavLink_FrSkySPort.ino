...
/*
Mavlink to FrSky X8R SPort interface using Teensy 3.1  http://www.pjrc.com/teensy/index.html
...
AccX            ( X Axis average vibration )
AccY            ( Y Axis average vibration )
AccZ            ( Z Axis average vibration )
...
uint8_t    ap_sat_visible = 0;              // How many visible satelites
...
/*
      ...
      case MAVLINK_MSG_ID_ATTITUDE:     //30
        ap_accX = mavlink_msg_attitude_get_roll(&msg);  //value comes in rads
        ap_accY = mavlink_msg_attitude_get_pitch(&msg);
        ap_accZ = mavlink_msg_attitude_get_yaw(&msg);
      break;
