...
--
--
--				FIRST CHANGE FOR ARDUPLANE
--
--				Changed FlightMode{} to Plane modes
--				Changed Wav files prefix from AVFM or ALFM to AVPFM and ALPFM to correspond 
--				to the specific Plane modes (note the P)
...
--User configurable 
			...
			-- These can be set in the future by a function script. TBD
				...
				Switches[1].FlightNumber=1 -- these correspond to the Logical Switches defined on the Radio - L1  is 1 =Manual
				Switches[2].FlightNumber=3 -- these correspond to the Logical Switches defined on the Radio - L2  is 3 =Stabilise
				Switches[3].FlightNumber=6 -- these correspond to the Logical Switches defined on the Radio - L3  is 6 =FBWA
				Switches[4].FlightNumber=12 -- these correspond to the Logical Switches defined on the Radio - L4  is 12 =RTL
				Switches[5].FlightNumber=8 -- these correspond to the Logical Switches defined on the Radio - L5  is 8 =Cruise
				Switches[6].FlightNumber=1 -- these correspond to the Logical Switches defined on the Radio - L6  is 1 =Manual
...
--Init Variables
	...
	local SwitchPos=0
	local FmodeNr=10 -- This is an invalid flight number when no data available
  	local Engaged=0
	...
	model.setTimer(1, {mode=0, start=0, value= 0, countdownBeep=0, minuteBeep=0, persistent=1})
		...
		--Init Flight Tables
			...
			for i=1, 16 do
			    ...
			    FlightMode[i] = {}
			    FlightMode[i].Name=""
			    FlightMode[i].SoundActive1="/SOUNDS/en/AVPFM"..(i-1).."A.wav"
			    FlightMode[i].SoundEngaged1="/SOUNDS/en/AVPFM"..(i-1).."E.wav"
